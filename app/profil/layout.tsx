  ...
  return (
    <>
      ...
      <style>{`
        ...
        /* Task 03 */ .profile-social-page .profile-social-avatar-row { position: relative; z-index: 3; }
        /* Task 04 */ .profile-social-page .profile-social-avatar { width: clamp(72px, 16vw, 92px); height: clamp(72px, 16vw, 92px); min-width: clamp(72px, 16vw, 92px); flex: 0 0 auto; display: grid; place-items: center; aspect-ratio: 1; line-height: 1; letter-spacing: -0.04em; }
        /* Task 05 */ .profile-social-page .profile-social-edit { min-height: 40px; padding: 9px 14px; gap: 7px; font-size: 0.78rem; font-weight: 700; white-space: nowrap; }
        .profile-social-page .profile-social-edit > svg { width: 15px; height: 15px; }
        /* Task 06 */ .profile-social-page .profile-social-name-row { display: flex; align-items: center; gap: 7px; min-width: 0; }
        ...
        /* Task 07 */ .profile-social-page .profile-social-full-name { margin: 5px 0 0; font-size: clamp(0.78rem, 2.5vw, 0.9rem); line-height: 1.4; opacity: 0.68; overflow-wrap: anywhere; }
        /* Task 08 */ .profile-social-page .profile-social-handle-row { display: flex; align-items: center; flex-wrap: wrap; gap: 7px 8px; margin-top: 9px; min-width: 0; }
        ...
        /* Task 09 */ .profile-social-page .profile-social-bio { max-width: 46rem; margin: 12px 0 0; font-size: clamp(0.84rem, 2.5vw, 0.94rem); line-height: 1.55; text-wrap: pretty; }
