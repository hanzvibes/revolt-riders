...
drop trigger if exists audit_member_profiles on public.member_profiles;
create trigger audit_member_profiles after insert or update or delete on public.member_profiles for each row execute function private.write_audit_log();
